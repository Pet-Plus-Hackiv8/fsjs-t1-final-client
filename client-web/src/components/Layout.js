            ...
            <div className="drawer-side ">
                ...
                <ul className="menu p-4 w-80 bg-[#eafdfc] text-base-content">
                    ...
                    <div>
                        ...
                        <li>
                            <NavLink to="/profile" className={({ isActive }) => isActive ? "font-bold bg-[#eafdfc] active:bg-[#ff9787] active:text-[#272822]" : "active:bg-[#ff9787] active:text-[#272822] "} >
                        ...
                        <li>
                            <NavLink to="/" className={({ isActive }) => isActive ? "font-bold bg-[#eafdfc] active:bg-[#ff9787] active:text-[#272822]" : "active:bg-[#ff9787] active:text-[#272822] "} >
                        ...
                        <li>
                            <NavLink to="/veterinarians" className={({ isActive }) => isActive ? "font-bold bg-[#eafdfc] active:bg-[#ff9787] active:text-[#272822]" : "active:bg-[#ff9787] active:text-[#272822] "} >
                                <svg fill="none" className="w-8 p-0" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                        ...
                        <li>
                            <NavLink to="/posts" className={({ isActive }) => isActive ? "font-bold bg-[#eafdfc] active:bg-[#ff9787] active:text-[#272822]" : "active:bg-[#ff9787] active:text-[#272822] "} >
                                <svg fill="none" className="w-8 p-0" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                        ...
                        <li>
                            <NavLink to="/histories" className={({ isActive }) => isActive ? "font-bold bg-[#eafdfc] active:bg-[#ff9787] active:text-[#272822]" : "active:bg-[#ff9787] active:text-[#272822] "} >
                                <svg fill="none" className="w-8 p-0" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
