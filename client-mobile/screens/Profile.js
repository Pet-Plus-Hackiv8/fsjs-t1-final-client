        ...
        <View style={styles.marginContainer}>
          ...
          <View>
            ...
            <View style={{ display: "flex", flexDirection: "row" }}>
              ...
              <Text style={{ fontSize: 15, fontWeight: "400" }}>maximumpride99</Text>
            </View>
          </View>
          <View style={{ display: "flex", flexDirection: "row", backgroundColor: "#e3e7fa", padding: 8, borderRadius: 10, elevation: 5 }}>
            <Ionicons name={"location-outline"} size={30} style={{ marginRight: 20 }} />
            <Text style={{ fontSize: 15, fontWeight: "400", alignSelf: "center" }}>Jakarta Selatan | Pondok Indah</Text>
          </View>
          <View style={{ display: "flex", flexDirection: "row", backgroundColor: "#e3e7fa", padding: 8, borderRadius: 10, elevation: 5 }}>
            <Ionicons name={"call-outline"} size={30} style={{ marginRight: 20 }} />
            <Text style={{ fontSize: 15, fontWeight: "400", alignSelf: "center" }}>+62 8218 8778 899</Text>
          </View>
