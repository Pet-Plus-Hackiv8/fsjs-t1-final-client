...
export default function PetDetailStack({route}) {
  ...
  return (
    <View style={{ height: yScreen }}>
      <View style={{ flex: 1 }}>
        <TouchableOpacity style={{ position: "absolute", zIndex: 10, marginHorizontal: 30, marginVertical: 50, backgroundColor: "white", padding: 10, borderRadius: 15 }} onPress={() => navigation.navigate("petsTab")}>
          <Image style={{ height: 20, width: 20 }} source={{ uri: "https://cdn-icons-png.flaticon.com/512/130/130882.png" }} />
        </TouchableOpacity>
        <Image style={{ height: yScreen / 2, width: xScreen }} source={{ uri: "https://i.pinimg.com/564x/9f/aa/a1/9faaa1fedc94c355a4256ba6207c7714.jpg" }} />
      </View>
          ...
          <View style={{ display: "flex", flexDirection: "row", justifyContent: "center", gap: 10 }}>
            ...
            <View>
              <View style={styles.dataBox}>
                ...
                <Text style={{ fontSize: 15, fontWeight: "bold" }}>20 lbs</Text>
              </View>
            </View>
            <View>
              <View style={styles.dataBox}>
                <Text style={{ fontSize: 13, fontWeight: "300" }}>Species</Text>
                <Text style={{ fontSize: 15, fontWeight: "bold" }}>Cat</Text>
              </View>
            </View>
          </View>
