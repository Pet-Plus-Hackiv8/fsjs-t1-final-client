...
export default function PetClinic({clinicData}) {
  ...
  return (
    <View style={{ marginVertical: 20 }}>
      ...
      <View>
          <TouchableOpacity style={{ maxHeight: 200, maxWidth: 170 }} onPress={() => navigation.navigate("hohDemo")}>
            <Image style={{ width: 170, height: 150, resizeMode: "cover", marginHorizontal: 5 }} source={{ uri: "https://i.pinimg.com/originals/95/e7/b5/95e7b509dd285cbf25140ebf22806383.gif" }} />
        ...
        {clinicData?.getAllPetshops?.map(el=>{
                return <View key={el.id}><TouchableOpacity style={{ maxHeight: 200, maxWidth: 170 }} onPress={() => navigation.navigate("detailClinic", {clinicId: el.UserId, serviceId: el.id})}>
                <Image style={{ width: 170, height: 150, resizeMode: "cover", marginHorizontal: 5 }} source={{ uri: el.logo }} />
                <Text style={styles.titleClinic}>{el.name}</Text>
                <Text style={styles.titleClinicDesc}>{getAddress(el.address)}</Text>
              </TouchableOpacity>
              </View>
        })}
        <View>
          <View style={{ maxHeight: 200, maxWidth: 170 }}>
            <Image style={{ width: 170, height: 150, resizeMode: "cover", marginHorizontal: 5 }} source={{ uri: "https://i.pinimg.com/564x/4c/35/00/4c350052ef20810241b8686eaa6abd29.jpg" }} />
        ...
        <View>
          <View style={{ maxHeight: 200, maxWidth: 170 }}>
            <Image style={{ width: 170, height: 150, resizeMode: "cover", marginHorizontal: 5 }} source={{ uri: "https://i.pinimg.com/564x/3e/c6/f4/3ec6f4590306e44ca36df6e5e0433966.jpg" }} />
        ...
        <View>
          <View style={{ maxHeight: 200, maxWidth: 170 }}>
            <Image style={{ width: 170, height: 150, resizeMode: "cover", marginHorizontal: 5 }} source={{ uri: "https://i.pinimg.com/736x/4f/d8/2a/4fd82ac3f1ea2a0f228686ebe2200cd5.jpg" }} />
